...
class CSVDataLoader:
    ...
    def _parse_row(row: dict[str, str]) -> HistoricalGame:
        ...
        return HistoricalGame(
            ...
            home_win_odds=_float_or_none(row["home_win_odds"]),
            away_win_odds=_float_or_none(row["away_win_odds"]),
            draw_odds=_float_or_none(row["draw_odds"]),
            closing_home_win_odds=_float_or_none(row["closing_home_win_odds"]),
            closing_away_win_odds=_float_or_none(row["closing_away_win_odds"]),
